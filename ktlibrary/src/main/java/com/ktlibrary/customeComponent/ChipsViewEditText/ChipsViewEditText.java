package com.ktlibrary.customeComponent.ChipsViewEditText;
...
public class ChipsViewEditText extends AutoCompleteTextView {
    ...
    public ChipsViewEditText(Context context) {
        super(context);
        init(null, 0, 0);
    }

    public ChipsViewEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0, 0);
    }

    public ChipsViewEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ChipsViewEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ChipsViewEditText, defStyleAttr, defStyleRes);
            try {
                mIsSpacesAllowedInTags = typedArray.getBoolean(R.styleable.ChipsViewEditText_allowSpaceInTag, false);
                mTagsTextColor = typedArray.getColor(R.styleable.ChipsViewEditText_tagsTextColor,
                        getColor(context, R.color.defaultTagsTextColor));
                mTagsTextSize = typedArray.getDimensionPixelSize(R.styleable.ChipsViewEditText_tagsTextSize,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsTextSize));
                mTagsBackground = typedArray.getDrawable(R.styleable.ChipsViewEditText_tagsBackground);
                mRightDrawable = typedArray.getDrawable(R.styleable.ChipsViewEditText_tagsCloseImageRight);
                mLeftDrawable = typedArray.getDrawable(R.styleable.ChipsViewEditText_tagsCloseImageLeft);
                mDrawablePadding = typedArray.getDimensionPixelOffset(R.styleable.ChipsViewEditText_tagsCloseImagePadding,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding));
                mTagsPaddingRight = typedArray.getDimensionPixelSize(R.styleable.ChipsViewEditText_tagsPaddingRight,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ChipsViewEditText_tagsPaddingLeft,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingTop = typedArray.getDimensionPixelSize(R.styleable.ChipsViewEditText_tagsPaddingTop,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
                mTagsPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.ChipsViewEditText_tagsPaddingBottom,
                        ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
            } finally {
                typedArray.recycle();
            }
